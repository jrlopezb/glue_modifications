...
CultivarBatchFile<-"M81-E_lit.SGC";
...
WorkDirectory<-getwd();
print(WorkDirectory)
WorkDirectorySubstrings<-unlist(strsplit(WorkDirectory,"DSSAT45"));

DSSATD<-paste(WorkDirectorySubstrings[1],"DSSAT45", sep=""); #Get the working directory of DSSAT.
...
if ((CropName != "MZ")& (CropName != "SC")& (CropName != "SW") & (CropName != "WH")& (CropName != "BA"))   
{
...
{
CurrentGenotypeFile<-paste(GD, "/MZCER045.CUL", sep="");
} else if (CropName == "SC")
{
CurrentGenotypeFile<-paste(GD, "/SCCAN045.CUL", sep="");
} else if (CropName == "SW")
{
CurrentGenotypeFile<-paste(GD, "/SWCER045.cul", sep="");
}else if  (CropName == "WH")
{
CurrentGenotypeFile<-paste(GD, "/WHCER045.CUL", sep="");
}else if  (CropName == "BA")
{
CurrentGenotypeFile<-paste(GD, "/BACER045.CUL", sep="");
}
...
#".CUL" under the "Genotype" folder of DSSAT, it was set as "MZCER045.CUL" as default value.
...
#while 8 is the length of cultivar file name, such as "MZCER045".
...
##"DSSBatch.v45" in the output directory.
